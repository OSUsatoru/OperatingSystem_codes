...
## Instruction
Write smallsh your own shell in C. smallsh will implement a subset of features of well-known shells, such as bash. Your program will
...
- stdour in mytestresults and stderr on window(stdout)
